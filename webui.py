...
parser.add_argument("--inbrowser", action='store_true', help="automatically launch the interface in a new tab on the default browser", default=True)
...
parser.add_argument("--save-metadata", action='store_true', help="Store generation parameters in the output png. Drop saved png into Image Lab to read parameters", default=True)
...
def load_SD_model():
    if opt.optimized:
        ...
        config = OmegaConf.load("optimized/v1-inference.yaml")
